                ...
                if (error.code === "auth/account-exists-with-different-credential") {
                    ...
                    if(email) {
                        ...
                        if(methods[0] == "microsoft.com") {
                            return { error: true, message: "Você já possui vínculo com uma conta Microsoft.\n Por favor, faça login com essa conta." }
                        } else if(methods[0] == "google.com") {
                            return { error: true, message: "Você já possui vínculo com uma conta Google.\n Por favor, faça login com essa conta." }
                        } else if(methods[0] == "github.com") {
                            return { error: true, message: "Você já possui vínculo com uma conta Github.\n Por favor, faça login com essa conta." }
                        }
                    }
                }
                return null
