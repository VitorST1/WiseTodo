<template>
	<div class="flex min-h-screen flex-col items-center justify-center gap-4 px-4">
		...
		<form class="flex w-full max-w-sm flex-col gap-5 rounded-md border border-slate-400/50 p-5">
			...
			>
				<img src="/google.svg" class="h-8 w-8" alt="Google logo" />
			...
			>
				<img src="/github.svg" class="h-8 w-8 invert dark:invert-0" alt="Github logo" />
			...
			>
				<img src="/microsoft.svg" class="h-8 w-8" alt="Microsoft logo" />
